...
using UiversityManagementSystem.Models;

namespace UiversityManagementSystem.Controllers
{
    [Authorize(Roles = "Teacher")]
    public class StudentsController : Controller
    {
        private UniversityManagementSystem_DBEntities db = new UniversityManagementSystem_DBEntities();
